...
class AbonosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.abonos.home', compact('abonos', 'titulo'));
    }
    ...
    {
        $titulo = 'en Espera';
        $abonos = $this->abonoRepository->searchBy(['estatus'=>'0']);
    ...
    {
        $titulo = ' Aprobados';
        $abonos = $this->abonoRepository->searchBy(['estatus'=>'1']);
    ...
    {
        $titulo = 'Rechazados';
        $abonos = $this->abonoRepository->searchBy(['estatus'=>'2']);
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/abonos/espera');
    ...
    public function updateTasa($id, Request $request)
    {
        ...
        $monto = $abono->monto_bs/$data['tasa'];

        $abono = $this->abonoRepository->update($id, [
            'tasa'=>$request['tasa'],
            'monto'=>$monto
        ]);

        return json_encode($abono, true);
