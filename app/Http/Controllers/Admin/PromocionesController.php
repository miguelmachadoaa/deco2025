...
class PromocionesController extends Controller
{
    ...
    {
        $paquetes = $this->paquetesRepository->searchBy(['type'=>'promocion']);

        return view('admin.promociones.home', compact('paquetes'));
    }

    public function add()
    {
        return view('admin.promociones.add', [
    ...
    public function store(Request $request)
    {
       ...
       // dd($data);
        ...
        return redirect(route('admin.promociones.index'))->with('message', 'Destino creado satisfactoriamente!');
    }
    ...
    public function duplicar($id)
    {
        ...
        return redirect(route('admin.promociones.index'))->with('message', 'Destino clonado satisfactoriamente!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('admin.promociones.edit', ['id'=>$id]))->with('message', 'Destino actualizado satisfactoriamente!');
    }
    ...
    public function detail($id)
    {
        ...
        return view('admin.promociones.detail', compact('destino'));
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return redirect(route('admin.promociones.index'))->with('message', 'Destino Eliminado satisfactoriamente!');
    }
    ...
    public function itinerario(Request $request){
        ...
        $view= View::make('admin.promociones.listaItinerarios', compact('itinerarios'));
