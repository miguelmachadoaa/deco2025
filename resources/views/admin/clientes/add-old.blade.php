      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Crear Producto <span></span></h3>
          </div>
          <div class="card-body">
            
            <form action="{{route('admin.products.store')}}" method="post" id="formproducts" class="">

                @csrf

                <input type="hidden" id="id_product" name="id_product" value="{{time()}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea required class="form-control" id="condiciones" name="condiciones" rows="3"></textarea>
