      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Actualizar Cotizacion del Dolar<span></span></h3>
          </div>
          <div class="card-body">
            
            <form
            action="{{route('admin.dolar.update', ['id'=>$dolar->id])}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                      <div class="col-sm-10">
                          ...
                          <a href="{{url('admin/contacto')}}" class="btn btn-info btn-style">Volver</a>
                      </div>
                  </div>
              </form>
          </div>
