      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Actualizar Categoria de Contrato <span></span></h3>
          </div>
          <div class="card-body">
            
            <form
            action="{{route('admin.contratos_categorias.update', ['id'=>$contratoCategoria->id])}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          ...
                          id="nombre"
                          name="nombre"
                          value="{{$contratoCategoria->nombre}}"
                          placeholder="nombre">
                      </div>
                </div>
                ...
                <div class="form-group row">
                      <div class="col-sm-10">
                          ...
                          <a href="{{url('admin/contratos_categorias')}}" class="btn btn-info btn-style">Volver</a>
                      </div>
                  </div>
              </form>
          </div>
