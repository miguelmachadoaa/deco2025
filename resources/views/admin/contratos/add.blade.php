      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Crear Tipo de Contrato <span></span></h3>
          </div>
          <div class="card-body">
            
            <form
            action="{{route('admin.contratos_tipos.store')}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Fecha de Creacion de contrato</label>
                    <div class="col-sm-10">
                        <input
                        required
                        type="date"
