      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          ...
          <div class="card-body">
            ...
            <form
            action="{{route('admin.destinos.update', ['id'=>$destino->id])}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control requerido" id="idioma" name="idioma" required>
                            <option @if($destino->idioma == 'es') Selected @endif value="es">Español</option>
                            <option @if($destino->idioma == 'en') Selected @endif value="en">Ingles</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control requerido" id="pais" name="pais" required>
                            ...
                            @foreach($paises as $pais)
                                <option value="{{$pais->sortname}}" @if($destino->pais == $pais->sortname) Selected  @endif>{{$pais->country_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <img width="120px" src="{{url('uploads/imagenes/'.$destino->imagen)}}" alt="">
                    </div>
                </div>
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="hidden" name="id_imagen" id="id_imagen" value="{{$destino->id}}">
