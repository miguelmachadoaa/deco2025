      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Formas de pago <span></span></h3>
          </div>
          <div class="card-body">
            
            <form
            action="{{route('admin.formas_pago.update', ['id'=>$formapago->id])}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Instrucciones de pago</label>
                    <div class="col-sm-10">
                        <textarea name="descripcion" id="descripcion" cols="30" rows="10">{{$formapago->descripcion}}</textarea>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Moneda</label>
                    <div class="col-sm-10">
                        <select class="form-control " id="moneda" name="moneda" >
                            <option @if($formapago->moneda == 'VES') Selected @endif  value="VES">Bolivares</option>
                            <option @if($formapago->moneda == 'USD') Selected @endif  value="USD">Dolares</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                      <div class="col-sm-10">
                          ...
                          <a href="{{url('admin/formas_pago')}}" class="btn btn-info btn-style">Volver</a>
                      </div>
                  </div>
              </form>
          </div>
