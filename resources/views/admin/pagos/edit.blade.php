      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Actualizar Tipo de Contrato <span></span></h3>
          </div>
          <div class="card-body">
            
            <form
            action="{{route('admin.contratos_tipos.update', ['id'=>$contratoTipo->id])}}"
            method="post"
            id="formproducts"
            class=""
            ...
            >
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Cuotas</label>
                    <div class="col-sm-10">
                        <input
                        required
                        type="number"
              ...
              <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Porcentaje</label>
                <div class="col-sm-10">
                    <input
                    required
                    type="number"
                ...
                <div class="form-group row">
                      <div class="col-sm-10">
                          ...
                          <a href="{{url('admin/contratos_tipos')}}" class="btn btn-info btn-style">Volver</a>
                      </div>
                  </div>
              </form>
          </div>
