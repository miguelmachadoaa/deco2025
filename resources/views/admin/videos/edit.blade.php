      ...
      <div class="col">
        ...
        <div class="card card_border py-2 mb-4">
          <div class="cards__heading">
              <h3>Editar Video <span></span></h3>
          </div>
          <div class="card-body">
                 
            <form
            action="{{route('admin.videos.update')}}"
            method="post"
            id="formproducts"
            ...
            class="">
                ...
                <input type="hidden" id="id_product" name="id_product" value="{{$video->id}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        id="descripcion"
                        name="descripcion"
                        rows="3">{{$video->descripcion}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        aria-label="Default select example">
                            ...
                            <option @if($video->estatus=="1") Selected @endif value="1">Si</option>
                            <option @if($video->estatus=="0") Selected @endif value="0">No</option>
                        </select>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label input__label">Imagen del video</label>
                    <div class="col-sm-10">
                        <input class="form-control" id="myfile" name="myfile" type="file" >
                        
                    </div>
                    <div class="col-sm-10">
                        <img width="60px" src="{{url('uploads/categorias/'.$video->imagen)}}" alt="">
                    </div>
                </div>
                  ...
                  <div class="form-group row">
                      <div class="col-sm-10">
                          ...
                          <a href="{{url('/admin/videos')}}" type="button" class="btn btn-danger btn-style">Volver</a>
                      </div>
                  </div>
              </form>
