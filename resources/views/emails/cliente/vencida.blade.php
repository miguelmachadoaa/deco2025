...
<p>Hola Estimado usuario, {{$contrato->cliente->nombre }} {{$contrato->cliente->apellido }} </p>
...
<p>  Su fecha de vencimiento fue el <b>  {{date('d/m/Y', strtotime($cuota->fecha))}}</b> . Para evitar cargos por mora, le solicitamos realizar el pago a la brevedad posible.  </p>
