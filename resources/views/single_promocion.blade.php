                        ...
                        <div class="blog-left blog-right-single">
                            <div class="blog-grid-one ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                            <img    src="{{url('uploads/imagenes/'.$paquete->imagen)}}" alt="{{$paquete->titulo}}">
                                    </div>
                                    <div class="col-sm-2"></div>
                                    <div class="col-sm-2"></div>

                                    <div class="col-sm-8 p-4 text-center">
                ...
                <div class="container">
                    <div class="blog">
                        ...
                        <div class="blog-left blog-right-single">
                            ...
                            @if($paquete->informacion != '' || $paquete->informacion != null )
                                <div class="row mt-4">
                                    <div class="col-sm-12 p-4 text-center">
                            ...
                            <div class="row">
                                ...
                                @if($paquete->include != '' || $paquete->include != null )
                               ...
                               @endif
                                ...
                                @if($paquete->noinclude != '' || $paquete->noinclude != null )
                                <div class="col-sm-6 mt-4">
                                    <div class="row">
                                        <div class="col-sm-12 mt-4 mb-4">
